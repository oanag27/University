...
class Console:
    ...
    def menu(self):
        ...
        print("18. Minimal spanning tree using the Kruskal's algorithm")
    ...
    def run_menu(self):
        while True:
            ...
            if choice == 0:
                ...
                minimalSpanningTree,totalCost = self.undirGraph.KruskalMinimumSpanningTree()
                # Print minimal spanning tree
                print("\nMinimal spanning tree Kruskal method:")
                for e in minimalSpanningTree: #print the edges
                    print(f"{e[0]} -- {e[1]}")
