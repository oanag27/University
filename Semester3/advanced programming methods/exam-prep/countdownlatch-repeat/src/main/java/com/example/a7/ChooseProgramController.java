                ...
                new CompStmt(new VarDeclStmt("v", new IntType()),
                        new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(0))),
                                new CompStmt(new RepeatStmt(
                                        new CompStmt(new ForkStatement(new CompStmt(new PrintStmt(new VarExp("v")),
                                                new AssignStmt("v", new ArithmExp(2, new VarExp("v"), new ValueExp(new IntValue(1)))))),
                                                new AssignStmt("v", new ArithmExp(1, new VarExp("v"), new ValueExp(new IntValue(1))))),
                                                                                ...
                                                                                new CompStmt(new AssignStmt("y", new ValueExp(new IntValue(2))),
                                                                                        new CompStmt(new AssignStmt("z", new ValueExp(new IntValue(3))),
                                                                                                new CompStmt(new AssignStmt("w", new ValueExp(new IntValue(4))),
                                                                                                        new PrintStmt(new ArithmExp(3, new VarExp("v"), new ValueExp(new IntValue(10)))))))))))))))
                                                ...
                                                new CompStmt(
                                                        new RepeatStmt(
                                                                new CompStmt(
                                                                        new ForkStatement(
                                                                                new CompStmt(
                                                                                        new PrintStmt(new VarExp("v")), new AssignStmt("v", new ArithmExp(2, new VarExp("v"), new ValueExp(new IntValue(1)))))), new AssignStmt("v", new ArithmExp(1, new VarExp("v"), new ValueExp(new IntValue(1))))), new RelationalExp(new VarExp("v"), new ValueExp(new IntValue(3)),"==")),
                                                        new CompStmt(
