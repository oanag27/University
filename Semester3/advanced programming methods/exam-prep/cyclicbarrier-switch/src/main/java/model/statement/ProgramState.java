...
public class ProgramState {
    ...
    public ProgramState(MyIStack<IStmt> newExeStack, MyIDictionary<String, Value> newSymTable, MyIList<Value> out, MyIDictionary<Value, BufferedReader> fileTable, IHeap<Integer, Value> heap,IBarrierTable barrierTable) {
        // for fork
    ...
    public ProgramState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl,
                    MyIList<Value> ot, IStmt prg ,MyIDictionary<Value, BufferedReader> fileTabl,IHeap<Integer, Value> heap,IBarrierTable barrierTable) {
        //for main
        this.exeStack = stk;
