...
public class ForkStatement implements IStmt {
    ...
    public ProgramState execute(ProgramState state) throws MyException {
        ...
        ToySemaphore newToySemaphoreTable = new ToySemaphore();
        ProgramState newProgramState = new ProgramState(newExeStack, newSymTable, state.getOut(), state.getFileTable(), state.getHeap(),state.getSemaphoreTable());
