...
public class ProgramState {
    ...
    private IToySemaphore toySemaphoreTable;
    static public Lock semaphoreLock = new ReentrantLock();
    private int id;
    private static int currentID = 1;

    public ProgramState(MyIStack<IStmt> newExeStack, MyIDictionary<String, Value> newSymTable, MyIList<Value> out, MyIDictionary<Value, BufferedReader> fileTable, IHeap<Integer, Value> heap,IToySemaphore toySemaphoreTable) {
        // for fork
    ...
    public ProgramState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl,
                    MyIList<Value> ot, IStmt prg ,MyIDictionary<Value, BufferedReader> fileTabl,IHeap<Integer, Value> heap,IToySemaphore toySemaphoreTable) {
        //for main
        this.exeStack = stk;
...
//        this.originalProgram = prg;         //recreate the entire original program
    ...
    public void setSemaphoreTable(IToySemaphore semaphoreTable) {
        this.toySemaphoreTable = semaphoreTable;
    }
    public IToySemaphore getSemaphoreTable() {
