        ...
        IStmt[] examples = new IStmt[]{
                ...
                new CompStmt(
                        ...
                        new CompStmt(
                                ...
                                new CompStmt(
                                        ...
                                        new CompStmt(
                                                new ConditionalStmt("c", new VarExp("b"), new ValueExp(new IntValue(100)), new ValueExp(new IntValue(200))),
                                                new CompStmt(
                                                        new PrintStmt(new VarExp("c")),
                                                        new CompStmt(
                                                                new ConditionalStmt("c", new ValueExp(new BoolValue(false)), new ValueExp(new IntValue(100)), new ValueExp(new IntValue(200))),
                                                                new PrintStmt(new VarExp("c"))
                                                        )
                                                )
                                        )
                ...
                new CompStmt(
                        ...
                        new CompStmt(
                                ...
                                new CompStmt(
                                        new HeapAllocation("v1", new ValueExp(new IntValue(2))),
                                        new CompStmt(
                                                new NewSemaphore("cnt", new HeapReading(new VarExp("v1")), new ValueExp(new IntValue(1))),
                                                new CompStmt(
                                                        new ForkStatement(
                                                                new CompStmt(
                                                                        new AcquireToyStatement("cnt"),
                                                                        new CompStmt(
                                                                                new HeapWriting(
                                                                                        "v1",
                                                                                        new ArithmExp(
                                                                                                3,
                                                                                                new HeapReading(new VarExp("v1")),
                                                                                                new ValueExp(new IntValue(10))
                                                                                        )
                                                                                ),
                                                                                new CompStmt(
                                                        ...
                                                        new CompStmt(
                                                                ...
                                                                new CompStmt(
                                                                        new AcquireToyStatement("cnt"),
                                                                        new CompStmt(
                                                                                new PrintStmt(new ArithmExp(2, new HeapReading(new VarExp("v1")), new ValueExp(new IntValue(1)))),  //value 2
                                                                                new ReleaseToyStatement("cnt")
                                                                        )
                                                                )
                                                        )
