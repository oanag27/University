...
---create/drop a table
CREATE PROCEDURE AddProjectTableP
AS
...
CREATE PROCEDURE AddNamePrimaryKeyProjectPR
AS
    ALTER TABLE Project
        DROP CONSTRAINT PK_Project
    ALTER TABLE Project
        ADD CONSTRAINT PK_Project PRIMARY KEY (ProjectID,ProjectName)
GO


CREATE PROCEDURE RemoveNamePrimaryKeyProjectPR
AS
    ALTER TABLE Project
        DROP CONSTRAINT PK_Project
    ALTER TABLE Project
...
--select * from Project
--EXEC AddNamePrimaryKeyProjectPR
--EXEC RemoveNamePrimaryKeyProjectPR
...
INSERT INTO ProcedureTable VALUES (3, 4, 'addUserAgeToUsersTable');
INSERT INTO ProcedureTable VALUES (4, 3, 'removeUserAgeToUsersTable');
INSERT INTO ProcedureTable VALUES (5, 6, 'DefaultQuantity');
INSERT INTO ProcedureTable VALUES (6, 5, 'DefaultQuantityRemoved');
INSERT INTO ProcedureTable VALUES (7, 8, 'AddProjectTableP');
INSERT INTO ProcedureTable VALUES (8, 7, 'RemoveProjectTable');
INSERT INTO ProcedureTable VALUES (9, 10, 'AddNamePrimaryKeyProjectPR');
INSERT INTO ProcedureTable VALUES (10, 9, 'RemoveNamePrimaryKeyProjectPR');
INSERT INTO ProcedureTable VALUES (11, 12, 'AddNameCandidateKeyProject');
INSERT INTO ProcedureTable VALUES (12, 11, 'RemoveNameCandidateKeyProject');
INSERT INTO ProcedureTable VALUES (13, 14, 'AddProjectNrForeignKey');
INSERT INTO ProcedureTable VALUES (14, 13, 'RemoveProjectNrForeignKey');

CREATE PROCEDURE moveToAVersion(@newVersion INT) AS
	DECLARE @current int
	DECLARE @procedureName varchar(255)
	SELECT @current=v FROM VersionTable
	WHILE @current < @newVersion BEGIN
		SELECT @procedureName=nameProcedure FROM ProcedureTable WHERE @current=fromVersion AND @current+1=intoVersion
		EXEC (@procedureName)
		SET @current=@current+1
		UPDATE VersionTable SET v=@current
	END
	WHILE @current > @newVersion BEGIN
		SELECT @procedureName=nameProcedure FROM ProcedureTable WHERE @current=fromVersion AND @current-1=intoVersion
		EXEC (@procedureName)
